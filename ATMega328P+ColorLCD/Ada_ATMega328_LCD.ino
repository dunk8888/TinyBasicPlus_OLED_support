...
// Special version for ATMega328, it provides just 296 bytes free memory.. (due to small
// 2 kB SRAM of ATMega328)
// v0.15  02/02/2015
...
int screenMem[274]; //the implementation of frame buffer is referenced from Ben Heck's
...
#endif
#endif /* ARDUINO */
//#define kRamSize  (RAMEND - 800 - kRamFileIO - kRamTones) 
#define kRamSize 400
#ifndef ARDUINO
// Not arduino setup
#include <stdio.h>
...
//			screenMem[147 + xg] = 32;
			...
			screenMem[105 + xg] = screenMem[126 + xg];		
			screenMem[126 + xg] = screenMem[147 + xg];
			screenMem[147 + xg] = screenMem[168 + xg];
			screenMem[168 + xg] = screenMem[189 + xg];
			screenMem[189 + xg] = screenMem[210 + xg];
			screenMem[210 + xg] = screenMem[252 + xg];
			screenMem[252 + xg] = screenMem[252 + xg];
			screenMem[252 + xg] = 32;
//			screenMem[252 + xg] = screenMem[273 + xg];
//			screenMem[273 + xg] = screenMem[294 + xg];
//			screenMem[294 + xg] = screenMem[252 + xg];
//			screenMem[252 + xg] = 32;
