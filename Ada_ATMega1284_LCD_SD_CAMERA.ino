...
/// SPI LCD version!
// Assuming ATMega1284P+SD card +Camera connection. At the moment of 02/22/2015, compiled by ArduinoIDE 1.06
...
#endif
#endif /* ARDUINO */
#define kRamSize  (RAMEND - 2400 - kRamFileIO - kRamTones) 
//#define kRamSize 400
#ifndef ARDUINO
// Not arduino setup
#include <stdio.h>
...
static const unsigned char sderrormsg[]       PROGMEM = "SD not found!";
