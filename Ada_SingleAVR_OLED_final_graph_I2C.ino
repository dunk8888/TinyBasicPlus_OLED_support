...
#include <Wire.h>
SFE_BMP180 pressure;
#define ALTITUDE 100.0 // Altitude of your position
#endif
...
#endif
#endif /* ARDUINO */
#define kRamSize  (RAMEND - 3000 - kRamFileIO - kRamTones - I2CIO) 
...
{
    char status;
  double T; // Return temp (deg C) in integer
...
{
    char status;
  double T,P; // Return pressure in double, but will be shown in integer..
