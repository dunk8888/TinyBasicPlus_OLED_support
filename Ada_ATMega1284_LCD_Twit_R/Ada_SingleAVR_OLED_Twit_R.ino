...
#endif
#endif /* ARDUINO */
#define kRamSize  (RAMEND - 4000 - kRamFileIO - kRamTones) 
//#define kRamSize 1000
#ifndef ARDUINO
// Not arduino setup
#include <stdio.h>
#include <stdlib.h>
...
//    printmsg(sdfilemsg);
 ...
 //   abort();
  ...
  iSDIO_connect(nextSequenceId, "PLEASE_INSERT_YOUR_WIFI_SSID_HERE", "PLEASE_INSERT_WIFI_PASSWORD");
  iSDIO_waitResponse(nextSequenceId);
...
int iSDIO_http(uint32_t sequenceId, const char* message) {
 // Serial.print(F("\nhttp command: \n"));
  ...
  const char *s2 = "\r\n\r\n_t=INSERT_YOUR_TOKEN_OF_STEWGATE-U&msg=";
  // and message
  const char *s3 = "\r\n\r\n";
