...
// Twitter enable version!
// Assuming ATMega1284P+SD card connection. At the moment of 02/22/2015, compiled by ArduinoIDE 1.06
// 
// v0.15  02/02/2015
...
#define TFT_CS     18
///////////// TFT_RST and TFT_DC is swapped to original Adafruit code /////////////
///////// Please swap if you use some standard shield ////////////////////////////
#define TFT_RST    20  
#define TFT_DC     19
...
#endif
#endif /* ARDUINO */
#define kRamSize  (RAMEND - 3000 - kRamFileIO - kRamTones) 
//#define kRamSize 400
#ifndef ARDUINO
// Not arduino setup
#include <stdio.h>
...
static const unsigned char sderrormsg[]       PROGMEM = "FlashAir error.";
static const unsigned char sdfilemsg[]        PROGMEM = "FlashAir OK!";
static const unsigned char initialair[]        PROGMEM = "Initializing FlashAir";
static const unsigned char slashmsg[]         PROGMEM = "/";
static const unsigned char spacemsg[]         PROGMEM = " ";
////////////////////////FlashAir related/////////
static const unsigned char ssid[]            PROGMEM = "SSID:";
static const unsigned char ipad[]            PROGMEM = "IP Address:";
static const unsigned char sbnt[]            PROGMEM = "Subnet Mask:";
static const unsigned char gtwy[]            PROGMEM = "Default Gateway:";
static const unsigned char pdns[]            PROGMEM = "Primary DNS Server:";
static const unsigned char adns[]            PROGMEM = "Alternate DNS Server: ";
static const unsigned char encr[]            PROGMEM = "Encryption Mode:";
/////////////////////////////////////////////////
...
circle:
  {
    ...
    if(expression_error)
          goto qwhat;
//tft.fillScreen(0);          
  tft.drawCircle(xpos,ypos,radius,1);
...
FILLCIRCLE:
  {
    ...
    if(expression_error)
          goto qwhat;
  tft.fillScreen(0);          
  tft.fillCircle(xpos,ypos,radius,1);
...
/// x y, w, h, t
  {
    ...
    if(expression_error)
          goto qwhat;
  tft.fillScreen(0);          
  tft.drawRoundRect(xpos,ypos,width,height,radius,1);
...
/// x y, w, h, t
  {
    ...
    if(expression_error)
          goto qwhat;
  tft.fillScreen(0);          
  tft.fillRoundRect(xpos,ypos,width,height,radius,1);
...
/// x0, y0, x1, y1, x2, y2
  {
    ...
    if(expression_error)
          goto qwhat;
  tft.fillScreen(0);          
  tft.drawTriangle(x0, y0, x1, y1, x2, y2,1); //last "1" is color white
...
/// x0, y0, x1, y1, x2, y2
  {
    ...
    if(expression_error)
          goto qwhat;
  tft.fillScreen(0);        
  tft.fillTriangle(x0, y0, x1, y1, x2, y2,1);
...
////////////////////////////////////
 ...
 //   abort();
  ...
  iSDIO_connect(nextSequenceId, "INSERT_YOUR_NET_SSID_HERE", "INSERT_YOUR_WIFI_PASSWORD_HERE");
  iSDIO_waitResponse(nextSequenceId);
#ifdef ENABLE_EEPROM
...
int iSDIO_http(uint32_t sequenceId, const char* message) {
 // Serial.print(F("\nhttp command: \n"));
  ...
  const char *s2 = "\r\n\r\n_t=INSERT_YOUR_TOKEN_FOR_stewgate-u_HERE&msg=";
  // and message
  const char *s3 = "\r\n\r\n";
...
static unsigned char twit_quoted_string(void)
{
  int i=0;
