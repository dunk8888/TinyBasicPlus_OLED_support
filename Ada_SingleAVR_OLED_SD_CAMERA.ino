...
// SPI OLED version
// v0.15bis2 23/02/2015
//     SSD1306 compatible OLED (128x64 dots) with SD card and camera supported.
//     unused part of source are deleted...
...
////// SD and camera library should be included before SSD1306 part, due to internal
////// memory assignment between SSD1306 and SD lib
...
boolean cameracheck;
//////////////// Graphic OLED(LCD) 128x64 support/////////////
#include <SPI.h>
#include <Wire.h>
...
#endif
#endif /* ARDUINO */
#define kRamSize  (RAMEND - 3500 - kRamFileIO - kRamTones) 
...
static const unsigned char sderrormsg[]       PROGMEM = "SD card not found";
...
////////////////////////////////////
    Serial.begin(4800);// opens serial for chatpad, sets data rate to 4800 bps
